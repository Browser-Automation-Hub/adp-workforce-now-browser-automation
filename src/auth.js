/**
 * auth.js — Authentication handler for ADP Workforce Now
 * Supports: SSO (SAML SSO), MFA (ADP MFA / SMS / TOTP)
 *
...
const BASE_URL = process.env.ADP_URL || 'https://workforcenow.adp.com/theme/workforcenow/login.html';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set ADP_USERNAME and ADP_PASSWORD in .env`);
  }

  console.log('Logging in to ADP Workforce Now...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
