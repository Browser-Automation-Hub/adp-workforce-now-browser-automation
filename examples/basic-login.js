/**
 * basic-login.js — Basic login example for ADP Workforce Now
...
async function main() {
  ...
  try {
    log('Starting ADP Workforce Now automation (Open Source mode)');
    ...
    const result = await login_adp(page, {
    ...
    // const data = await run_payroll_report(page, {});
    // log('Data:', data);
